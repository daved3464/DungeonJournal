...
namespace DungeonJournal {
    public class CharacterSheet : Object, Json.Serializable {
        // Info
        public string character_avatar { get; set; default = ""; }
        ...
        public override Json.Node serialize_property(string property_name, Value value, ParamSpec pspec) {
            ...
            if (value.type().is_a(typeof (ArrayList))) {
                // Array convertion to Glib.Object array
                unowned ArrayList<Object> list_value = value as ArrayList<Object>;
                ...
                if (list_value != null) {
                    ...
                    // Populate the JSON Array with the original array items
        ...
        private ArrayList get_arraylist_for_type<T>(Json.Array array) {
            var list = new ArrayList<T>();

            array.foreach_element((arr, idx, node) => {
                T item = Json.gobject_deserialize(typeof (T), node);
                assert(item != null);
                list.add(item);
            });
